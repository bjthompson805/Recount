...
-- Routed through ns.NewLocale (see Recount-LocaleCore.lua) so English itself is
-- selectable from the Addon Language dropdown on a non-English client. isDefault
-- stays true; debug is forwarded as AceLocale's silent flag.
local _, ns = ...
local L = ns.NewLocale("enUS", true, debug)
...
L["Data is a secret value (available after combat)."] = true
...
L["Mana Gained"] = true
L["Mana Given"] = true
L["Mana Given Abilities"] = true
L["Mana Given Recipients"] = true
L["Mana Sources"] = true
L["Max"] = true
L["Melee"] = true
...
L["Prefix"] = true
L["Prevented"] = true
L["Prevented For"] = true
L["Prevention Abilities"] = true
L["Previous"] = true
L["Profiles"] = true
...
L["'s Damage Prevented"] = true
L["'s Damage Prevented For"] = true
L["'s Dispels"] = true
L["'s DOT Uptime"] = true
L["'s DPS"] = true
L["'s DTPS"] = true
...
L["Yes"] = true
-- v1.18.4: UI Language Override (Addon Language dropdown)
L["Addon Language"] = true
L["Choose the language for Recount's own text. Game item, spell, and unit names still use your client's language."] = true
L["Recount language updated - type /reload to apply it everywhere."] = true
