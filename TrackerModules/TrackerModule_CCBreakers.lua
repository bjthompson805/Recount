...
function Recount:SpellAuraBroken(_timestamp, _eventtype, srcGUID, srcName, srcFlags, dstGUID, dstName, dstFlags, spellId, spellName, _spellSchool, extraSpellId, extraSpellName, _extraSpellSchool)
...
function Recount:AddCCBreaker(source, victim, ability, srcGUID, srcFlags, dstGUID, dstFlags, _extraSpellId)
