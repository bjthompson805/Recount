...
function Recount:SpellInterrupt(_timestamp, _eventtype, srcGUID, srcName, srcFlags, dstGUID, dstName, dstFlags, _spellId, spellName, _spellSchool, extraSpellId, extraSpellName, _extraSpellSchool)
...
function Recount:AddInterruptData(source, victim, ability, srcGUID, srcFlags, dstGUID, dstFlags, _spellId)
